# Codex 主 Agent 基础指令快照

## 快照信息

以下 fenced block 逐字转录自真实 rollout 的 `session_meta.payload.base_instructions.text`：

- session: `019f69f8-1394-71b3-a0e3-2821d2e79fcf`
- client: Codex Desktop
- CLI: `0.144.2`
- captured: 2026-07-16
- length: 16,299 characters / 146 lines

它只是 base instructions。权限、app context、skills/plugins、multi-agent policy、environment 和用户任务位于后续 developer/user 层，见 `assembly-map.md` 与请求样例。
