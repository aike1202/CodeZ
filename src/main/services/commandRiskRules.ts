export const SAFE_PREFIXES = [
  ...
  'Out-Null', 'Where-Object', 'ForEach-Object', 'Get-Member', 'ConvertFrom-Json',
  'ConvertTo-Json', 'Write-Output', 'Write-Host', 'Get-Alias', 'Get-Help', 'Get-Module',
  'Get-FileHash', 'Get-ExecutionPolicy',
